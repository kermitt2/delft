...
if __name__ == '__main__':
    ...
    monogram_file = os.path.join(fdir, 'wordlists/wordlist_mono_clean.txt');
    bigram_file = os.path.join(fdir, 'wordlists/wordlist_bi_clean.txt');
    ...
    for i, word in enumerate(string_list):
        ...
        scipy.misc.imsave(os.path.join(output_dir, filename + '.png'), paint_text(word, img_w, img_h, rotate=False, ud=False, multi_fonts=True)[0, :, :].T)
