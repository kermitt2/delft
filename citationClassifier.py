...
if __name__ == "__main__":
    ...
    if args.action == 'train':
        ...
        train(embeddings_name, args.fold_count, use_ELMo=use_ELMo, use_BERT=use_BERT)

    if args.action == 'train_eval':
        if args.fold_count < 1:
            raise ValueError("fold-count should be equal or more than 1")

        y_test = train_and_eval(embeddings_name, args.fold_count, use_ELMo=use_ELMo, use_BERT=use_BERT)    
