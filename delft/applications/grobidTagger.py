...
def train_eval(model, embeddings_name=None, architecture='BidLSTM_CRF', transformer=None,
               ...
               features_indices=None, max_sequence_length=-1, batch_size=-1, max_epoch=-1, use_ELMo=False, output_eval_raw_data=None):
    print('Loading data...')
...
# split data, train a GROBID model and evaluate it
def eval_(model, input_path=None, architecture='BidLSTM_CRF', use_ELMo=False,  output_eval_raw_data=None):
    print('Loading data...')
    if input_path is None:
