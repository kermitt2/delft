...
def get_model(
    ...
    if config.architecture == BidLSTM.name:
        ...
        return BidLSTM(config, ntags, registry=registry)
        ...
        preprocessor.return_lengths = True
        config.use_crf = True
        return BidLSTM_CRF(config, ntags, registry=registry)
        ...
        return BidLSTM_ChainCRF(config, ntags, registry=registry)
        ...
        preprocessor.return_chars = True
        preprocessor.return_lengths = True
        return BidLSTM_CNN(config, ntags, registry=registry)
        ...
        preprocessor.return_lengths = True
        config.use_crf = True
        return BidLSTM_CNN_CRF(config, ntags, registry=registry)
        ...
        preprocessor.return_lengths = True
        config.use_crf = True
        return BidGRU_CRF(config, ntags, registry=registry)
        ...
        preprocessor.return_lengths = True
        config.use_crf = True
        return BidLSTM_CRF_FEATURES(config, ntags, registry=registry)
        ...
        config.use_crf = True
        config.use_chain_crf = True
        return BidLSTM_ChainCRF_FEATURES(config, ntags, registry=registry)
        ...
        preprocessor.return_lengths = True
        config.use_crf = True
        return BidLSTM_CRF_CASING(config, ntags, registry=registry)
...
class BaseModel(object):
    ...
    def init_transformer(
        ...
        self.transformer_preprocessor = BERTPreprocessor(
            transformer.tokenizer, preprocessor.empty_features_vector(), preprocessor.empty_char_vector()
        )
...
class BidLSTM(BaseModel):
    ...
    def __init__(self, config, ntags=None, registry=None):
        super().__init__(config, ntags, registry=registry)
        ...
        x = Bidirectional(
            LSTM(units=config.num_word_lstm_units, return_sequences=True, recurrent_dropout=config.recurrent_dropout)
        )(x)
        x = Dropout(config.dropout)(x)
...
class BidLSTM_CRF(BaseModel):
    ...
    def __init__(self, config, ntags=None, registry=None):
        ...
        self.model.build(
            input_shape=[
                (None, None, config.word_embedding_size),
                (None, None, config.max_char_length),
                (None, None, 1),
            ]
        )
        # self.model.summary()
...
class BidLSTM_CNN(BaseModel):
    ...
    def __init__(self, config, ntags=None, registry=None):
        ...
        casing_embedding = Embedding(
            input_dim=config.case_vocab_size,
...
class BidGRU_CRF(BaseModel):
    ...
    def __init__(self, config, ntags=None, registry=None):
        ...
        x = Bidirectional(
            GRU(units=config.num_word_lstm_units, return_sequences=True, recurrent_dropout=config.recurrent_dropout)
        )(x)
        x = Dropout(config.dropout)(x)
        x = Bidirectional(
            GRU(units=config.num_word_lstm_units, return_sequences=True, recurrent_dropout=config.recurrent_dropout)
...
class BidLSTM_CRF_FEATURES(BaseModel):
    ...
    def __init__(self, config, ntags=None, registry=None):
        ...
        features_embedding = TimeDistributed(
            ...
            name="features_embedding_td",
        )(features_input)

        features_embedding_bd = TimeDistributed(
            Bidirectional(LSTM(config.features_lstm_units, return_sequences=False)), name="features_embedding_td_2"
        )(features_embedding)
        ...
        self.model.build(
            input_shape=[
                (None, None, config.word_embedding_size),
                (None, None, config.max_char_length),
                (None, None, len(config.features_indices)),
                (None, None, 1),
            ]
        )
        self.config = config
...
class BERT(BaseModel):
    ...
    def __init__(
        ...
        super().__init__(config, ntags, load_pretrained_weights, local_path, registry=registry)
        ...
        embedding_layer = transformer_layers(
            input_ids_in, token_type_ids=token_type_ids, attention_mask=attention_mask
        )[0]
...
class BERT_FEATURES(BaseModel):
    ...
    def __init__(
        ...
        text_embedding_layer = transformer_layers(
            input_ids_in, token_type_ids=token_type_ids, attention_mask=attention_mask
        )[0]
        ...
        self.model = Model(
            inputs=[input_ids_in, features_input, token_type_ids, attention_mask], outputs=[label_logits]
        )
        self.config = config
...
class BERT_CRF(BaseModel):
    ...
    def __init__(
        ...
        super().__init__(config, ntags, load_pretrained_weights, local_path=local_path, registry=registry)
...
class BERT_CRF_CHAR(BaseModel):
    ...
    def __init__(
        ...
        chars = TimeDistributed(
            Bidirectional(LSTM(config.num_char_lstm_units, return_sequences=False)), name="chars_rnn"
        )(char_embeddings)
...
class BERT_CRF_CHAR_FEATURES(BaseModel):
    ...
    def __init__(
        ...
        base_model = Model(
            inputs=[input_ids_in, char_input, features_input, token_type_ids, attention_mask], outputs=[x]
        )
        self.model = CRFModelWrapperForBERT(base_model, ntags)
        self.model.build(
            input_shape=[
