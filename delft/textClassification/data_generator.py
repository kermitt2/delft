...
set_random_seed(7)
import keras
from delft.textClassification.preprocess import to_vector_single, to_vector_simple_with_elmo, to_vector_simple_with_flair
...
class DataGenerator(keras.utils.Sequence):
    ...
    def __data_generation(self, index):
        ...
        if self.embeddings.use_FLAIR:     
            batch_x = to_vector_simple_with_flair(x_tokenized, self.embeddings, self.maxlen)  
