...
class cnn2(BaseTextClassifier):
    ...
    def __init__(self, model_config, training_config):
        ...
        self.conv2 = nn.Conv1d(self.recurrent_units, self.recurrent_units, kernel_size=2, padding='same')
        self.conv3 = nn.Conv1d(self.recurrent_units, self.recurrent_units, kernel_size=2, padding='same')
        self.gru = nn.GRU(self.recurrent_units, self.recurrent_units, batch_first=True, dropout=self.dropout_rate)
        self.dense1 = nn.Linear(self.recurrent_units, self.dense_size)
        self.dense2 = nn.Linear(self.dense_size, self.nb_classes)
...
class cnn3(BaseTextClassifier):
    ...
    def __init__(self, model_config, training_config):
        ...
        self.gru = nn.GRU(self.embed_size, self.recurrent_units, batch_first=True, dropout=self.dropout_rate)
...
class lstm_cnn(BaseTextClassifier):
    ...
    def __init__(self, model_config, training_config):
        ...
        self.lstm = nn.LSTM(self.embed_size, self.recurrent_units, batch_first=True, dropout=self.dropout_rate)
        self.dropout = nn.Dropout(self.dropout_rate)
        self.conv1 = nn.Conv1d(self.recurrent_units, self.recurrent_units, kernel_size=2, padding='same')
...
class gru(BaseTextClassifier):
    ...
    def __init__(self, model_config, training_config):
        ...
        self.bigru1 = nn.GRU(self.embed_size, self.recurrent_units, batch_first=True, bidirectional=True, dropout=self.dropout_rate)
        self.bigru2 = nn.GRU(self.recurrent_units * 2, self.recurrent_units, batch_first=True, bidirectional=True, dropout=self.dropout_rate)
        self.dropout = nn.Dropout(self.dropout_rate)
...
class gru_simple(BaseTextClassifier):
    ...
    def __init__(self, model_config, training_config):
        ...
        self.bigru = nn.GRU(self.embed_size, self.recurrent_units, batch_first=True, bidirectional=True, dropout=self.dropout_rate)
        self.dense1 = nn.Linear(self.recurrent_units * 4, self.dense_size)
        self.dense2 = nn.Linear(self.dense_size, self.nb_classes)
...
class gru_lstm(BaseTextClassifier):
    ...
    def __init__(self, model_config, training_config):
        ...
        self.bigru = nn.GRU(self.embed_size, self.recurrent_units, batch_first=True, bidirectional=True, dropout=self.dropout_rate)
        self.bilstm = nn.LSTM(self.recurrent_units * 2, self.recurrent_units, batch_first=True, bidirectional=True, dropout=self.dropout_rate)
        self.dropout = nn.Dropout(self.dropout_rate)
        self.dense1 = nn.Linear(self.recurrent_units * 4, self.dense_size)
        self.dense2 = nn.Linear(self.dense_size, self.nb_classes)
...
class dpcnn(BaseTextClassifier):
    ...
    def __init__(self, model_config, training_config):
        ...
        # Block 1
        self.conv1a = nn.Conv1d(self.recurrent_units, self.recurrent_units, kernel_size=2, stride=3, padding=0)
        self.conv1b = nn.Conv1d(self.recurrent_units, self.recurrent_units, kernel_size=2, stride=3, padding=0)
        
        # Block 2
        self.conv2a = nn.Conv1d(self.recurrent_units, self.recurrent_units, kernel_size=2, stride=3, padding=0)
        self.conv2b = nn.Conv1d(self.recurrent_units, self.recurrent_units, kernel_size=2, stride=3, padding=0)
